...
export function SavedJobListItem({
  ...
  return (
    <Link href={`/jobs/${slug}`} className="w-full md:w-[48%]">
      <div className="flex h-full items-center gap-3 rounded-xl border border-border bg-card p-4 shadow-soft transition-all duration-200 hover:-translate-y-0.5 hover:border-border hover:shadow-card-hover">
        ...
        <Bookmark
          size={18}
          className="shrink-0 fill-indigo-600 text-primary"
          aria-hidden="true"
        />
      </div>
    </Link>
