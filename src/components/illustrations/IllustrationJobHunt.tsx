...
export default function IllustrationJobHunt({
  width = 200,
  height = 200,
  className = "",
}: IconNoSelectedProps) {
  return (
    ...
    >
      ...
      <g id="freepik--Newspaper--inject-54">
        <g id="freepik--news-paper--inject-54">
          <path
      ...
      <g id="freepik--speech-bubbles--inject-54">
